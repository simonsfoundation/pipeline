...
BCCIODIR = /mnt/xfs1/bioinfoCentos7/software/installs/bcbio_nextgen/150617
PICARDDIR = $(BCBIODIR)/share/java/picard-1.96
#GENOMEREF = $(BCBIODIR)/genomes/Hsapiens/GRCh37/seq/GRCh37.fa
GENOMEREF = $(BCBIODIR)/genomes/Hsapiens/GRCh37/seq/GRCh37.fa
GATK = /mnt/xfs1/bioinfo/software/builds/GATK/fromGitZip150607/gatk-protected-master/target/executable/GenomeAnalysisTK.jar
DBSNP = $(BCBIODIR)/genomes/Hsapiens/GRCh37/variation/dbsnp_138.vcf.gz
