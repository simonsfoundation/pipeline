...
#fi
#
make -j $P -f ${srcdir}/fxgrBam.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$indir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
make -j $P -f ${srcdir}/flStBam.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$metricsdir LOGDIR=$outdir SUFFIX=-fxgr
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
make -j $P -f ${srcdir}/genomeCvrgBed.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=-fxgr
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
make -j $P -f ${srcdir}/filter23Bed.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=-fxgr 
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
make -j $P -f ${srcdir}/filter23Bam.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=-fxgr 
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
make -j $P -f ${srcdir}/splitBam.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=-fxgr 
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
make -j $P -f ${srcdir}/callGATK_HC.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=-bin 
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
#make -j $P -f ${srcdir}/gatkCombVar.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$outdir LOGDIR=$outdir SUFFIX=-bin.vcf.gz
#ret=$?
#echo $ret
#if [ $ret -ne 0 ]; then
#    echo 'gatkCombVar.mk INCLMK=$inclmk finished with errors'
#    exit 1
#fi
...
make -j $P -f ${srcdir}/callFreebayes.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=-bin 
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
make -j $P -f ${srcdir}/callPlatypus.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=-bin
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
...
make -j $P -f ${srcdir}/callGATK_HC_JOINT.mk INCLMK=$inclmk FAMCODE=$famcode INDIR=$workdir OUTDIR=$workdir LOGDIR=$outdir SUFFIX=-23
ret=$?
echo $ret
if [ $ret -ne 0 ]; then
